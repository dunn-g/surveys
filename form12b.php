...
document.location.href='form14.php'; // ur desired redirect page path where u want to go with recent submit data u can also in same page
</script>";
	...
	<head><meta charset="UTF-8">
      ...
      <script>
         ...
         function saveAndNext(){
            if (!document.getElementById) return;
            formObj = document.getElementById("form12");
            formObj.submit();
            <!--document.forms["form14.php"].loadForm();-->
            <!--document.location.href = "form12.php";-->
            document.location.href = 'form14.php';
         }
         ...
         function saveAndPrev(){
            ...
            <!--document.forms["form14.php"].loadForm();-->
            <!--document.location.href = "form12.php";-->
            document.location.href = 'form10.php';
         }
...
-->
            ...
            <button class="savebutton" type="submit" onclick="saveAndPrev()" name="submit">Save & Prev Form</button>
            <button class="savebutton" type="submit" onclick="saveAndNext()" name="submit">Save & Next Form</button> <!-- --> 
